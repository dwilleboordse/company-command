...
import { LayoutDashboard, BarChart2, Target, Calendar, Video, LogOut, Settings, TrendingUp, Camera, Users } from 'lucide-react'
    ...
    <div className="app-layout">
      <aside className="sidebar">
        ...
        <div className="sidebar-footer">
          ...
          <div className="user-chip" onClick={()=>fileRef.current?.click()} title="Click to change photo">
            <div className="user-avatar">
              {avatarUrl||profile?.avatar_url ? <img src={avatarUrl||profile?.avatar_url} alt="avatar"/> : initials}
            </div>
