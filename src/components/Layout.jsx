...
import { LayoutDashboard, Target, Calendar, Video, LogOut, Settings, TrendingUp, Users, DollarSign, Menu, X, FileText, Trophy, Heart, UserCheck } from 'lucide-react'
    ...
    <div className="app-layout">
      ...
      <aside className={`sidebar ${sidebarOpen?'open':''}`}>
        ...
        <nav className="sidebar-nav">
          ...
          <NavLink to="/milestones" className={nl}><Target size={16}/> Milestones</NavLink>
