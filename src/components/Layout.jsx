...
import { LayoutDashboard, BarChart2, Target, Calendar, Video, LogOut, Settings, TrendingUp, Users, DollarSign, Menu, X, FileText, Trophy } from 'lucide-react'
    ...
    <div className="app-layout">
      ...
      <aside className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
        ...
        <nav className="sidebar-nav">
          ...
          <NavLink to="/changelog" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
