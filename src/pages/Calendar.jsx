...
import { today as getToday, getMondayStr, getMonday, addDays as addD, parseLocal, fmtDisplay as fmtD, DAYS as WDAYS } from '../lib/dates'
...
function DayCell({ userId, date, isOwn }) {
  ...
  const dateStr=fmt(date), isToday=getToday()===dateStr
