    ...
    <>
      ...
      <div className="page-body">
        ...
        <div style={{display:'flex',gap:8,flexWrap:'wrap',marginBottom:20,alignItems:'center'}}>
          ...
          {/* Role filter — only in All Teams view */}
          {viewMode==='all'&&(
        ...
        {loading?(
          ...
          if (viewMode==='team') {
            // My Team: show user's team objectives + company as context
            const myTeamObjs = isManagement
              ? teamObjs  // management sees all team objectives
          ...
          // All Teams view — every objective, optionally role-filtered
          const filtered = roleFilter==='all'
            ? objectives
            : objectives.filter(o=>o.role_type===roleFilter)
          return filtered.map(obj=>renderObjCard(obj))
        })()}
      </div>
