  ...
  return (
    <div style={{display:'flex',alignItems:'center',gap:10,padding:'8px 0',borderBottom:'1px solid var(--border-light,var(--border))'}}>
      ...
      <div style={{flex:1,minWidth:0}}>
        <span style={{fontSize:13,color:isDone?'var(--text-muted)':'var(--text-primary)',textDecoration:isDone?'line-through':'none',fontWeight:isDone?400:500}}>
          {ms.milestone_name}
        </span>
        {ms.notes&&<div style={{fontSize:11,color:'var(--text-muted)',marginTop:1}}>{ms.notes}</div>}
      </div>
